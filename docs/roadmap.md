...
- offline-first API backend
- plan + execute workflow
- policy and approvals
- reminders/history storage
...
- policy rules editor UI
- benchmark harness + quality metrics
- per-profile memory and encrypted secrets
- plugin framework for external tools/devices
